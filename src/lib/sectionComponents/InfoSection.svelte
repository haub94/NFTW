<script lang="ts">
    export let title :string="Where to go. When to go.";
    export let text1 :string="Lorem Ipsum Dolor 2";
    export let text2 :string="Lorem Ipsum Dolor 2";
</script>
  ...
  <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
    ...
    >
      ...
      >
        ...
        >
          <img
            src="/planets/rainbow-planet.png"
            alt=""
        ...
        >
          ...
          >
            <img
              src="/planets/striped-planet.png"
              alt=""
