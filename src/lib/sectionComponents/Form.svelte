<script lang="ts">
  ...
  validateDate("2023-04-12", "2023-05-12");
...
<div class="relative isolate bg-NFTW-bg bg-opacity-50">
  ...
  <div class="absolute z-30 top-0 w-full">
    {#if bannerStatus === 100}
      <Banner buzzWord="invalid date!" text="Please check the end- / startdate. The end- and startdate must be in the future." color="red" />
