        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div>
            ...
            >
              ...
              >
              <option class="bg-NFTW-black-600 bg-opacity-90">Honeymoon</option>
              <option class="bg-NFTW-black-600 bg-opacity-90"
                >Our Recommendations</option
              >
              <option class="bg-NFTW-black-600 bg-opacity-90">Phototour</option>
              <option class="bg-NFTW-black-600 bg-opacity-90">Vacation</option>
            </select>
          </div>

          <!-- {#if birthdayspecial||honeymoon} -->
          <div>
            <label
              for="startdate"
              class="block text-sm font-semibold leading-6 text-NFTW-white"
