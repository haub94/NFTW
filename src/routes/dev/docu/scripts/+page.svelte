    ...
    {#each scriptData as script}
        <div id={script.name} class="bg-gray-100 rounded-lg p-4 shadow-lg">
            <div class="px-4 sm:px-0">
                <h3 class="text-base font-semibold leading-7 text-gray-900">{script.name}</h3>
                <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-500">{script.description}</p>
            </div>
            <div class=" border-NFTW-black-50">
                <dl class="divide-y divide-gray-500">
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900">Author</dt>
                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{script.author}</dd>
                </div>
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900">Version</dt>
                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{script.version}</dd>
                </div>
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt class="text-sm font-medium leading-6 text-gray-900">Variables</dt>
                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                        <table>
                            <thead>
                            <tr>
                ...
                <div class="py-6">
                    ...
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                        <div class="h-auto">
                          <div  class="my-4 flex rounded-lg border-2 border-gray-300 p-4 overflow-scroll max-h-screen">
                              <!--code preview-->
                              <div class="flex-row">
                                <pre>
                                    {script.script} 
