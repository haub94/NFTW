...
<h2 class="underline underline-offset-2 text-cyan-500 font-bold text-xl ml-4">
  Daten von der DB:
</h2>
<button
  on:click={loadDbData}
  class="border-2 ml-4 mt-2 rounded-full p-2 bg-indigo-500 border-indigo-800 hover:bg-indigo-600"
  >LOAD DATA</button
>
